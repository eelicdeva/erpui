...
// eelic-i18n setting     
  ...
  config: {
    name: 'Parameter Name',
    namePlaceholder: 'Please enter a parameter name',
    keyName: 'Parameter Key Name',
    ...
    confirm1: 'Are you sure to delete the data item whose parameter number is " ',
    confirm2: ' "?',
  ...
  staff : {
    HrStaff : {
        staffId : 'Staff Id',
        staffIdPlaceholder : 'Please Enter Staff Id',
        staffNo : 'Staff Number',
        staffNoPlaceholder : 'Please Enter Staff Number',
        staffName : 'Name',
        staffNamePlaceholder : 'Please Enter Name',
        birth : 'Birthplace',
        birthPlaceholder : 'Please Enter Birthplace',
        sex : 'Gender',
        sexPlaceholder : 'Please Enter Gender',
        dateIn : 'Date of hire',
        dateInPlaceholder : 'Please Enter Date of hire',
        dateOut : 'Date of resignation',
        dateOutPlaceholder : 'Please Enter Date of resignation',
        nik : 'National Identification Number',
        nikPlaceholder : 'Please Enter National Identification Number',
        maritalStatus : 'Marital Status',
        maritalStatusPlaceholder : 'Please Enter Marital Status',
        nationality : 'Nationality',
        nationalityPlaceholder : 'Please Enter Nationality',
        blood : 'Blood Type',
        bloodPlaceholder : 'Please Enter Blood Type',
        religion : 'Religion',
        religionPlaceholder : 'Please Enter Religion',
        tel : 'Tel',
        telPlaceholder : 'Please Enter Tel',
        tel1 : 'Emergency Tel',
        tel1Placeholder : 'Please Enter Emergency Tel',
        zip : 'Zip Code',
        zipPlaceholder : 'Please Enter Zip Code',
        email : 'E-mail',
        emailPlaceholder : 'Please Enter E-mail',
        address : 'Domicile Address',
        addressPlaceholder : 'Please Enter Domicile Address',
        addressIdCard : 'Address',
        addressIdCardPlaceholder : 'Please Enter Address',
        education : 'Education Experience',
        educationPlaceholder : 'Please Enter Education Experience',
        eduGrade : 'Education Grade',
        eduGradePlaceholder : 'Please Enter Education Grade',
        staffImage : 'Staff Image',
        staffImagePlaceholder : 'Please Select Staff Image',
        eduImage : 'Education Image',
        eduImagePlaceholder : 'Please Select Education Image',
        idCardImage : 'Id Card Image',
        idCardImagePlaceholder : 'Please Select Id Card Image',
        form1Image : 'form1 Image',
        form1ImagePlaceholder : 'Please Select form1 Image',
        form2Image : 'form2 Image',
        form2ImagePlaceholder : 'Please Select form2 Image',
        otherImage : 'other Image',
        otherImagePlaceholder : 'Please Select other Image',
        memo : 'Memo',
        memoPlaceholder : 'Please Enter Memo',
        addStaff : 'Add staff',
        EditStaff : 'Edit staff',
        confirmDelete: 'Are you sure to delete the data item whose personnel number is " ',
     }
  }
}
