...
// eelic-i18n setting  
  ...
  genTable: {
   ...
   confirmSync1: 'Anda yakin ingin memaksakan sinkronisasi struktur tabel " ',
   confirmSync2: ' "?',
  ...
  SysLang : {
    zhCn : "Bahasa China i18n",
    zhCnPlaceholder : "Silakan masukkan Bahasa Cina i18n",
    enUs : "Bahasa Inggris i18n",
    enUsPlaceholder : "Silakan masukan bahasa Inggris i18n",
    idId : "Bahasa Indonesia i18n",
    idIdPlaceholder : "Silakan masukan bahasa Indonesia i18n",
    langIdx : "Primary Key",
    langIdxPlaceholder : "Silakan masukkan Primary Key",
    langKey : "Kunci Bahasa",
    langKeyPlaceholder : "Silakan masukan Kunci Bahasa",
    langTb : "Nama Tabel",
    langTbPlaceholder : "Silakan masukkan Nama Tabel",
    langFn : "Nama Kolom",
    langFnPlaceholder : "Silakan masukkan Nama Kolom",
    modifyI18n: 'Ubah i18n Lang',
    cleanRecord: 'Apakah Anda yakin untuk menghapus semua item data rekaman i18n?',
    confirmDeleteRecord1: 'Apakah Anda yakin akan menghapus item data dengan nomor lang " ',
    confirmDeleteRecord2: ' " ? ',
  },
  config: {
    name: 'Nama Parameter',
    namePlaceholder: 'Silakan masukkan nama parameter',
    keyName: 'Nama Kunci Parameter',
    keyNamePlaceholder: 'Silahkan masukkan nama kunci parameter',
    type: 'Sistem Bawaan',
    id: 'Parameter Id',
    key: 'Kunci Parameter',
    keyPlaceholder: 'Masukkan nilai kunci parameter',
    rules1: 'Nama parameter tidak boleh kosong',
    rules2: 'Nama kunci parameter tidak boleh kosong',
    rules3: 'Nilai kunci parameter tidak boleh kosong',
    addParameters: 'Tambah Parameter',
    modifyParameters: 'Ubah Parameter',
    confirm1: 'Apakah Anda yakin akan menghapus item data yang nomor parameternya adalah " ',
    confirm2: ' "?',
    refreshSuccess: 'Refresh cache berhasil',
  },
staff : {
  HrStaff : {
    staffId : 'Id Karyawan',
    staffIdPlaceholder : 'Masukkan ID Karyawan',
    staffNo : 'Nomor Karyawan',
    staffNoPlaceholder : 'Masukkan Nomor Karyawan',
    staffName : 'Nama',
    staffNamePlaceholder : 'Masukkan Nama Karyawan',
    birth : 'Tempat Lahir',
    birthPlaceholder : 'Masukkan Tempat Lahir Karyawan',
    sex : 'Jenis Kelamin',
    sexPlaceholder : 'Masukkan Jenis Kelamin Karyawan',
    dateIn : 'Tanggal Masuk',
    dateInPlaceholder : 'Masukkan Tanggal Masuk Karyawan',
    dateOut : 'Tanggal Resign',
    dateOutPlaceholder : 'Masukkan Tanggal Resign Karyawan',
    nik : 'Nomor Induk Kependudukan',
    nikPlaceholder : 'Masukkan Nomor Induk Kependudukan Karyawan',
    maritalStatus : 'Status Pernikahan',
    maritalStatusPlaceholder : 'Masukkan Status Pernikahan Karyawan',
    nationality : 'Kebangsaan',
    nationalityPlaceholder : 'Masukkan Kebangsaan Karyawan',
    blood : 'Golongan Darah',
    bloodPlaceholder : 'Masukkan Golongan Darah Karyawan',
    religion : 'Agama',
    religionPlaceholder : 'Masukkan Agama Karyawan',
    tel : 'Telepon',
    telPlaceholder : 'Masukkan Nomor Telepon Karyawan',
    tel1 : 'Telepon Darurat',
    tel1Placeholder : 'Masukkan Nomor Telepon Darurat Karyawan',
    zip : 'Kode Pos',
    zipPlaceholder : 'Masukkan Kode Pos Karyawan',
    email : 'Email',
    emailPlaceholder : 'Masukkan Email Karyawan',
    address : 'Alamat Domisili',
    addressPlaceholder : 'Masukkan Alamat Domisili Karyawan',
    addressIdCard : 'Alamat',
    addressIdCardPlaceholder : 'Masukkan Alamat Sesuai KTP Karyawan',
    education : 'Pendidikan Terakhir',
    educationPlaceholder : 'Masukkan Pendidikan Terakhir Karyawan',
    eduGrade : 'Grade Pendidikan',
    eduGradePlaceholder : 'Masukkan Grade Pendidikan Karyawan',
    staffImage : 'Foto Karyawan',
    staffImagePlaceholder : 'Masukkan Foto Karyawan',
    eduImage : 'Foto Ijazah',
    eduImagePlaceholder : 'Masukkan Foto Ijazah Karyawan',
    idCardImage : 'Foto KTP',
    idCardImagePlaceholder : 'Masukkan Foto KTP Karyawan',
    form1Image : 'Foto Formulir 1',
    form1ImagePlaceholder : 'Masukkan Foto Formulir 1 Karyawan',
    form2Image : 'Foto Formulir 2',
    form2ImagePlaceholder : 'Masukkan Foto Formulir 2 Karyawan',
    otherImage : 'Foto Lainnya',
    otherImagePlaceholder : 'Masukkan Foto Lainnya Karyawan',
    memo : 'Memo',
    memoPlaceholder : 'Masukkan Memo Karyawan',
    addStaff : 'Tambah karyawan',
    EditStaff : 'Edit karyawan',
    confirmDelete: 'Apakah Anda yakin akan menghapus item data yang nomor personelnya adalah " ',
  }
}
